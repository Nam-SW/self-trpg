...
주인공은 세계관의 중심적인 인물일수도, 전혀 중요하지 않은 엑스트라에 불과할 수도 있습니다. 이야기의 시작은 100글자 이내로 간결하게 작성합니다.
...
**작성할 내역**
 ...
 - start_event (str): 이야기의 시작이 될 때의 사건입니다. 100글자 이내로 간결히 작성합니다.


세계관의 무대 내에서 활동할 주인공을 정하고, 주인공의 현재 위치, 이야기의 시작이 될 내용을 json 형태로 출력합니다(``` 등으로 감싸지 않습니다).
